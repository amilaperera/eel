...
set(STM32HAL_INCLUDE_DIR ${CMAKE_SOURCE_DIR}/src/ots/stm32_cube/${STM32_FAMILY_LOWER}/STM32${STM32_FAMILY_UPPER}xx_HAL_Driver/Inc)

# export all the sources
foreach(SRC ${HAL_SOURCES})
  find_file(FILE_${SRC} ${SRC}
    PATH_SUFFIXES Src
    PATHS ${CMAKE_SOURCE_DIR}/src/ots/stm32_cube/${STM32_FAMILY_LOWER}/STM32${STM32_FAMILY_UPPER}xx_HAL_Driver)
