...
elseif (${STM32_FAMILY_UPPER} STREQUAL "F1")
    list(APPEND FreeRTOS_SRCS GCC/ARM_CM3/port.c)
    list(APPEND FreeRTOS_INCLUDE_DIRS ${FreeRTOS_ROOT_PATH}/Source/portable/GCC/ARM_CM3)
elseif (${STM32_FAMILY_UPPER} STREQUAL "F4")
    list(APPEND FreeRTOS_SRCS GCC/ARM_CM4F/port.c)
    list(APPEND FreeRTOS_INCLUDE_DIRS ${FreeRTOS_ROOT_PATH}/Source/portable/GCC/ARM_CM4F)
endif()
