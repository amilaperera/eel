...
if (CMAKE_CROSSCOMPILING)
  ...
  if (NOT EelMcu)
    ...
    if (${EelMcu} MATCHES "^[sS][tT][mM]32.*")
      ...
      # Now parse CPU_FLAG
      if ("${STM32_FAMILY_UPPER}" STREQUAL "F1")
        set(CPU_FLAG "-mcpu=cortex-m3" CACHE INTERNAL "cpu flag")
      elseif ("${STM32_FAMILY_UPPER}" STREQUAL "F4")
        set(CPU_FLAG "-mcpu=cortex-m4" CACHE INTERNAL "cpu flag")
        set(FPU_FLAG "-mfpu=fpv4-sp-d16" CACHE INTERNAL "fpu flag")
        set(FLOAT_ABI "-mfloat-abi=hard" CACHE INTERNAL "float abi")
      else ()
      endif ()

      set(EEL_MCU_FLAGS "${CPU_FLAG} -mthumb ${FPU_FLAG} ${FLOAT_ABI}")
    else ()
