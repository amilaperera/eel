...
if(CMAKE_CROSSCOMPILING)
  if(NOT EEL_LINKER_SCRIPT)
    ...
    if(NOT LINKER_SCRIPT)
      ...
      set(EEL_LINKER_SCRIPT ${CMAKE_CURRENT_LIST_DIR}/../platform/stm32/f1/linker_script/${LINKER_SCRIPT})
    endif()
  endif()

  if (NOT LINKER_SET)
    message(STATUS "Linker script: ${EEL_LINKER_SCRIPT}")
    set(CMAKE_EXE_LINKER_FLAGS "-T${EEL_LINKER_SCRIPT}" CACHE INTERNAL "executable linker flags")
    set(LINKER_SET TRUE CACHE INTERNAL "linker set or not")
  endif()
endif()
